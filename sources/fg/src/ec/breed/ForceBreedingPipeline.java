 ...
 * individuals its source produces may be as low as 1. This is useful for
 * forcing Crossover to produce only one individual, or mutation to produce 2
 * individuals always, etc.
 * 
 * <p>
 ...
 * <td valign=top>(The number of individuals this breeding pipeline will force
 * its source to produce each time in order to fill the quo for produce(...).)</td>
 * </tr>
 * </table>
 * 
 * <p>
