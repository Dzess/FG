...
/**
 * ReproductionPipeline is a BreedingPipeline which simply makes a copy of the
 * individuals it recieves from its source. If the source is another
 * BreedingPipeline, the individuals have already been cloned, so
 * ReproductionPipeline won't clone them again...unless you force it to do so by
 * turning on the <tt>must-clone</tt> parameter.
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base.</i><tt>must-clone</tt><br>
 * <font size=-1>bool = <tt>true</tt> or <tt>false</tt> (default)</font></td>
 * <td valign=top>(do we <i>always</i> clone our individuals, or only clone if
 * the individual hasn't already been cloned by our source? Typically you want
 * <tt>false</tt>)</td>
 * </tr>
 * 
 * </table>
...
public class ReproductionPipeline extends BreedingPipeline {
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        if (likelihood != 1.0)
            state.output
                    .warning(
                            "ReproductionPipeline given a likelihood other than 1.0.  This is nonsensical and will be ignored.",
    ...
    public int produce(final int min, final int max, final int start, final int subpopulation, final Individual[] inds,
        ...
        // this code is basically the same as BreedingPipeline.reproduce() but
        // we copy it here
