...
/**
 * An ADM is an ADF which doesn't evaluate its arguments beforehand, but instead
 * only evaluates them (and possibly repeatedly) when necessary at runtime. For
 * more information, see ec.gp.ADF.
 * 
 * @see ec.gp.ADF
 * 
 * @author Sean Luke
