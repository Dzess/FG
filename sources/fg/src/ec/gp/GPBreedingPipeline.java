...
/**
 * A GPBreedingPipeline is a BreedingPipeline which produces only members of
 * some subclass of GPSpecies. This is just a convenience superclass for many of
 * the breeding pipelines here; you don't have to be a GPBreedingPipeline in
 * order to breed GPSpecies or anything.
 * 
 * @author Sean Luke
 * @version 1.0
 */
