...
/**
 * GPFunctionSet is a Clique which represents a set of GPNode prototypes forming
 * a standard function set for forming certain trees in individuals.
 ...
 * GPFunctionSets store their GPNode Prototypes in three hashtables, one for all
 * nodes, one for nonterminals, and one for terminals. Each hashed item is an
 * array of GPNode objects, hashed by the return type of the GPNodes in the
 * array.
 * 
 * GPFunctionSets also contain prototypical GPNode nodes which they clone to
 * form their arrays.
 * 
 * <p>
 * <b>Parameters</b><br>
 ...
 * <td valign=top>(name of function set. Must be different from other function
 * set instances)</td>
 * </tr>
 * 
 * <tr>
 ...
 * <td valign=top>(number of functions in the function set)</td>
 * </tr>
 * 
 * <tr>
 * <td valign=top><i>base</i>.<tt>func.</tt><i>n</i><br>
 * <font size=-1>classname, inherits and != ec.gp.GPNode</font></td>
 * <td valign=top>(class of function node <i>n</i> in the set)</td>
 * </tr>
 * 
 * </table>
 * 
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base</i>.<tt>func.</tt><i>n</i></td>
 * <td>function node <i>n</i></td>
 * </tr>
 * </table>
 * 
 * 
...
public class GPFunctionSet implements Clique {
    ...
    public GPNode[][] nodes;
    /**
     * The nonterminals our GPTree can use: arrays of nonterminals hashed by
     * type.
     */
    ...
    /**
     * Nonterminals <= a given arity, that is:
     * nonterminalsUnderArity[type][arity][thenodes] -- this will be O(n^2).
     * Obviously, the number of nonterminals at arity slot 0 is 0.
     */
    public GPNode[][][] nonterminalsUnderArity;

    /**
     * Nonterminals >= a given arity, that is:
     * nonterminalsOverArity[type][arity][thenodes] -- this will be O(n^2).
     * Obviously, the number of nonterminals at arity slot 0 is all the
    ...
    /**
     * Sets up all the GPFunctionSet, loading them from the parameter file. This
    ...
    /**
     * Returns the function set for a given name. You must guarantee that after
     * calling functionSetFor(...) one or several times, you call
     * state.output.exitIfErrors() once.
     */

    public static GPFunctionSet functionSetFor(final String functionSetName, final EvolutionState state) {
        GPFunctionSet set = (GPFunctionSet) (((GPInitializer) state.initializer).functionSetRepository
                .get(functionSetName));
        if (set == null)
