...
/**
 * <p>
 * GETruncationPipeline removes the unused genes from the end of the vector. The
 * number of used chromosomes are tracked by GESpecies' <b>comsumed(...)</b>
 * function.
 * 
 * Note: truncaton only occurs if the number of comsumed genes is greater than
 * 1.
 * </p>
 * 
 * <p>
