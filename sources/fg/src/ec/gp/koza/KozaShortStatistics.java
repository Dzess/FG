 ...
 * <li>(if gather-full) how long initialization took in milliseconds, or how
 * long the previous generation took to breed to form this generation
 * <li>(if gather-full) how many bytes initialization took, or how how many
 * bytes the previous generation took to breed to form this generation. This
 * utilization is an approximation only, made by the Java system, and does not
 * take into consideration the possibility of garbage collection (which might
 * make the number negative).
 * <li>(if gather-full) How long evaluation took in milliseconds this generation
 * <li>(if gather-full) how many bytes evaluation took this generation. This
 * utilization is an approximation only, made by the Java system, and does not
 * take into consideration the possibility of garbage collection (which might
 * make the number negative).
 * </ul>
 ...
 * <ul>
 * <li>(if gather-full) The average number of nodes used per individual this
 * generation
 * <li>(if gather-full) [a|b|c...], representing the average number of nodes
 * used in tree <i>a</i>, <i>b</i>, etc. of individuals this generation
 * <li>(if gather-full) The average number of nodes used per individual so far
 * in the run
 * <li>(if gather-full) The average depth of any tree per individual this
 * generation
 * <li>(if gather-full) [a|b|c...], representing the average depth of tree
 * <i>a</i>, <i>b</i>, etc. of individuals this generation
 * <li>(if gather-full) The average depth of any tree per individual so far in
 * the run
