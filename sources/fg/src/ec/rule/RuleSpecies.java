...
/**
 * RuleSpecies is a simple individual which is suitable as a species for rule
 * sets subpopulations. RuleSpecies' individuals must be RuleIndividuals, and
 * often their pipelines are RuleBreedingPipelines (at any rate, the pipelines
 * will have to return members of RuleSpecies!).
 * 
 * <p>
 * <b>Default Base</b><br>
 * rule.species
