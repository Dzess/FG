...
public class Slave {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                MersenneTwisterFast[] random = new MersenneTwisterFast[breedthreads > evalthreads ? breedthreads
                        : evalthreads];
    ...
    public static void evaluateGroupedProblemForm(EvolutionState state, boolean returnIndividuals,
        ...
        ((GroupedProblemForm) (state.evaluator.p_problem)).evaluate(state, inds, updateFitness, countVictoriesOnly,
                subpops, 0);
