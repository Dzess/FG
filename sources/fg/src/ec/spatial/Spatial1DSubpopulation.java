...
/**
 * A Spatial1DSubpopulation is an EC subpopulation that is additionally embedded
 * into a one-dimmensional space. In a spatially-embedded EA, the subpopulations
 * of individuals are assumed to be spatially distributed in some sort of space,
 * be it one-dimmensional, two- dimmensional, or whatever else. The space may or
 * may not be toroidal (although it usually is). Each location in the space has
 * a set of neighboring locations. Thus, each individual has an index in the
 * subpopulation, and also a location in the space.
 * 
 * <p>
 * This public interface provides a method to obtain the indexes of the
 ...
 * <table>
 * <tr>
 * <td valign=top><tt>toroidal</tt><br>
 * <font size=-1>true (default) or false</font></td>
 * <td valign=top>(Is this space toroidal?)</td>
 * </tr>
 * 
 * 
 * 
...
public class Spatial1DSubpopulation extends Subpopulation implements Space {
    /**
     * This parameter stipulates whether the world is toroidal or not. If
     * missing, its default value is true.
     */
     ...
     */
    /*
     * public int locationToIndex( final Object location ) { if( location
     * instanceof Integer ) return ((Integer)location).intValue(); return -1; }
     */
     ...
     */
    /*
     * public Object indexToLocation( final int index) { return new
     * Integer(index); }
     */
