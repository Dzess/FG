...
/**
 * This selection method adds parsimony pressure to the regular tournament
 * selection. The comparison of individuals is based on fitness with probability
 * <i>prob</i>, and it is based on size with probability <i>1-prob</i>. For each
 * pairwise comparsion of individuals, the ProportionalTournamentSelection
 ...
 * 
 * <tr>
 * <td valign=top><i>base.</i><tt>fitness-prob</tt><br>
 * <font size=-1> double &gt;= 0 and &lt;= 1</font></td>
 * <td valign=top>(the probability of comparing individuals based on fitness,
 * rather than size)</td>
 * </tr>
 * 
 * </table>
