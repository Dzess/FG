 ...
 * "http://mail-archives.apache.org/mod_mbox/jakarta-jcs-dev/200803.mbox/%3C1066089445.1204637680849.JavaMail.jira@brutus%3E"
 * > apache mail-archives</a>.
 * 
 * This code was published in the public domain, but I believe it was probably
 * intended to be distributed under the Apache license, like the rest of the
 * Jakarta code. That license is listed at the end of this file.
 * 
 */
                ...
                for (Enumeration inetAddrs = iface.getInetAddresses(); inetAddrs.hasMoreElements();) {
                    ...
                    if (!inetAddr.isLoopbackAddress()) {
                        if (inetAddr.isSiteLocalAddress())
                            return inetAddr; // Found non-loopback site-local
                                             // address.
