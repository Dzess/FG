...
/**
 * A LogRestarter is an abstract superclass of objects which are capable of
 * restarting logs after a computer failure. LogRestarters subclasses are
 * generally used internally in Logs only; you shouldn't need to deal with them.
 * 
 * @author Sean Luke
 * @version 1.0
 */
