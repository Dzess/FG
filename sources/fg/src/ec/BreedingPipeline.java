...
public abstract class BreedingPipeline extends BreedingSource implements SteadyStateBSourceForm {
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        if (numsources <= DYNAMIC_SOURCES) {
            ...
            if (numsources == 0)
                state.output.fatal("Breeding pipeline num-sources value must be > 0", base.push(P_NUMSOURCES),
     ...
     * true, then
     */
    public int reproduce(final int n, final int start, final int subpopulation, final Individual[] inds,
            final EvolutionState state, final int thread, boolean produceChildrenFromSource) {
