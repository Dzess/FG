...
public class MultipleVectorCrossoverPipeline extends BreedingPipeline {
     ...
     */
    public int multipleBitVectorCrossover(final int min, final int max, final int start, final int subpopulation,
     ...
     * whenever necessary by default.
     */
    public int multipleByteVectorCrossover(final int min, final int max, final int start, final int subpopulation,
            final Individual[] inds, final EvolutionState state, final int thread) {
     ...
     * whenever necessary by default.
     */
    public int multipleGeneVectorCrossover(final int min, final int max, final int start, final int subpopulation,
            final Individual[] inds, final EvolutionState state, final int thread) {
     ...
     * whenever necessary by default.
     */
    public int multipleLongVectorCrossover(final int min, final int max, final int start, final int subpopulation,
            final Individual[] inds, final EvolutionState state, final int thread) {
