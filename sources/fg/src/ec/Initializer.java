 ...
 * population at the beginning of the run. It does this by providing a
 * population through the initialPopulation(...) method.
 * 
 * <p>
 * <b>Parameters</b><br>
 * <table>
 * <tr>
 * <td valign=top><tt>pop</tt><br>
 * <font size=-1>classname, inherits or = ec.Population</font></td>
 * <td valign=top>(the class for a new population)</td>
 * </tr>
 * </table>
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><tt>pop</tt></td>
 * <td>The base for a new population's set up parameters</td>
 * </tr>
 * </table>
 * 
 * @author Sean Luke
...
public abstract class Initializer implements Singleton {
     ...
     * This is commonly done by setting up a Population (by calling
     * setupPopulation below) then calling its populate() method. This method
