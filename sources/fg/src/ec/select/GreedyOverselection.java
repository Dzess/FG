 ...
 * 
 * <p>
 * This selection method first divides individuals in a population into two
 * groups: the "good" ("top") group, and the "bad" ("bottom") group. The best
 * <i>top</i> percent of individuals in the population go into the good group.
 * The rest go into the "bad" group. With a certain probability (determined by
 * the <i>gets</i> setting), an individual will be picked out of the "good"
 * group. Once we have determined which group the individual will be selected
 * from, the individual is picked using fitness proportionate selection in that
 * group, that is, the likelihood he is picked is proportionate to his fitness
 * relative to the fitnesses of others in his group.
 * 
 * <p>
 * All this is expensive to set up and bring down, so it's not appropriate for
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base.</i><tt>top</tt><br>
 * <font size=-1>0.0 &lt;= float &lt;= 1.0</font></td>
 * <td valign=top>(the percentage of the population going into the "good" (top)
 * group)</td>
 * </tr>
 * <tr>
 * <td valign=top><i>base.</i><tt>gets</tt><br>
 * <font size=-1>0.0 &lt;= float &lt;= 1.0</font></td>
 * <td valign=top>(the likelihood that an individual will be picked from the
 * "good" group)</td>
 * </tr>
 * </table>
 * 
