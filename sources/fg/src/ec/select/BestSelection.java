...
/**
 * Picks among the best <i>n</i> individuals in a population in direct
 * proportion to their absolute fitnesses as returned by their fitness() methods
 * relative to the fitnesses of the other "best" individuals in that <i>n</i>.
 * This is expensive to set up and bring down, so it's not appropriate for
 ...
 * <td valign=top>(should we pick from among the <i>worst n</i> individuals in
 * the tournament instead of the <i>best n</i>?)</td>
 * </tr>
 * <tr>
 * <td valign=top><i>base.</i><tt>n</tt><br>
 * <font size=-1> int > 0 (default is 1)</font></td>
 * <td valign=top>(the number of best-individuals to select from)</td>
 * </tr>
 * </table>
 * 
 * <p>
