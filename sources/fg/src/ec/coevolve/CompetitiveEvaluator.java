...
public class CompetitiveEvaluator extends Evaluator {
	...
	public void evalRoundRobin(final EvolutionState state, int[] from, int[] numinds, final Individual[] individuals, int subpop,
			final GroupedProblemForm prob) {
	 ...
	 * @param prob
	 */
	public void evalRoundRobinPopChunk(final EvolutionState state, int from, int numinds, int threadnum, final Individual[] individuals,
	...
	public void evalNRandomOneWay(final EvolutionState state, int[] from, int[] numinds, final Individual[] individuals, int subpop,
			final GroupedProblemForm prob) {
		if (state.evalthreads == 1)
	...
	public void evalNRandomOneWayPopChunk(final EvolutionState state, int from, int numinds, int threadnum, final Individual[] individuals,
			final int subpop, final GroupedProblemForm prob) {
		Individual[] queue = new Individual[individuals.length];
		int len = queue.length;
		System.arraycopy(individuals, 0, queue, 0, len);
	...
	public void evalNRandomTwoWay(final EvolutionState state, int[] from, int[] numinds, final Individual[] individuals, int subpop,
			final GroupedProblemForm prob) {
		if (state.evalthreads == 1)
	...
	public void evalNRandomTwoWayPopChunk(final EvolutionState state, int from, int numinds, int threadnum, final Individual[] individuals,
			final int subpop, final GroupedProblemForm prob) {
