 ...
 * 
 * <p>
 * First, all the individuals in the population are created. <b>(A)</b>Then all
 * individuals in the population are evaluated. Then the population is replaced
 * in its entirety with a new population of individuals bred from the old
 * population. Goto <b>(A)</b>.
 * 
 * <p>
