...
import pl.alife.fg.ui.printing.inner.JavaContext;
import pl.alife.fg.ui.printing.inner.JavaEditorKit;
import pl.alife.fg.ui.printing.inner.Token;
...
public class ResultsDialog extends JDialog implements ActionListener {
    ...
    private JFormattedTextField getTextClassName() {
        if (textClassName == null) {
            ...
            textClassName.setText("pl.alife.fg.Function");
