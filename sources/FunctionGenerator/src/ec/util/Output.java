...
public class Output implements Serializable {
	...
	public synchronized int addLog(File file, int _verbosity, boolean postAnnouncements, boolean appendOnRestart, boolean gzip)
			throws IOException {
	...
	public static InputStream makeCompressingInputStream(InputStream in) {
		 ...
		 */
		try {
			return (InputStream) (Class.forName("com.jcraft.jzlib.ZInputStream").getConstructor(new Class[] { InputStream.class })
