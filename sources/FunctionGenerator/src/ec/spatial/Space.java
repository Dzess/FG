...
/**
 * In a spatially-embedded EA, the subpopulations of individuals are assumed to
 * be spatially distributed in some sort of space, be it one-dimmensional, two-
 * dimmensional, or whatever else. The space may or may not be toroidal
 * (although it usually is). Each location in the space has a set of neighboring
 * locations. Thus, each individual has an index in the subpopulation, and also
