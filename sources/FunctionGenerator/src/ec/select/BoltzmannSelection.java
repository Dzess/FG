...
/**
 * Similar to FitProportionateSelection, but with a Simulated Annealing style
 * twist. BoltzmannSelection picks individuals of a population in proportion to
 * an adjusted version of their fitnesses instead of their actual fitnesses as
 * returned by fitness(). The adjusted fitness is calculated by
 * e^(fitness/current_temperature) where current_temperature is a temperature
 * value that decreases by a constant cooling rate as generations of evolution
 * pass. The current_temperature is calculated by starting-temperature -
 * (cooling-rate * the_current_generation_number). When the temperature dips
 * below 1.0, annealing ceases and BoltzmannSelection reverts to normal
 * FitProportionateSelection behavior.
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base.</i><tt>starting-temperature</tt><br>
 * <font size=-1>double = some large number (defaults to 1.0)</font></td>
 * <td valign=top>(the starting temperature for our simulated annealing style
 * adjusted fitness proportions)</td>
 * </tr>
 * 
 * <tr>
 * <td valign=top><i>base.</i><tt>cooling-rate</tt><br>
 * <font size=-1> double = some smaller number (defaults to 0.0 which causes
 * BoltzmannSelection to behave just as FitProportionateSelection would)</font></td>
 * <td valign=top>(how slow, or fast, do you want to cool the annealing fitness
 * proportions?)</td>
 * </tr>
 * 
 * </table>
