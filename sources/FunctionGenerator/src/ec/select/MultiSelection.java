 ...
 * SelectionMethods. Each time it must produce an individual, it picks one of
 * these SelectionMethods at random and has it do the production instead.
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base</i>.<tt>num-selects</tt><br>
 * <font size=-1>int &gt;= 1</font></td>
 * <td valign=top>(The number of subordinate SelectionMethods)</td>
 * </tr>
 * 
 * <tr>
 * <td valign=top><i>base</i>.<tt>select.</tt><i>n</i><br>
 * <font size=-1>classname, inherits and != SelectionMethod</tt><br>
 * <td valign=top>(Subordinate SelectionMethod <i>n</i>)</td>
 * </tr>
 * </table>
 * 
 * <p>
 ...
 * <tr>
 * <td valign=top><i>base</i>.<tt>select.</tt><i>n</i><br>
 * <td>Subordinate SelectionMethod <i>n</i></td>
 * </tr>
 * </table>
 * 
 * @author Sean Luke
