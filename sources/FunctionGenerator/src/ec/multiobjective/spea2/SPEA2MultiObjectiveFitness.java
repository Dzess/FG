...
/**
 * SPEA2MultiObjectiveFitness is a subclass of MultiObjectiveFitness which adds
 * three auxiliary fitness measures used in SPEA2: strength S(i), kthNNDistance
 * D(i), and a final fitness value R(i) + D(i). Note that so-called
 * "raw fitness" (what Sean calls "Wimpiness" in Essentials of Metaheuristics)
 * is not retained.
 * 
 * <p>
