...
/**
 * This SimpleBreeder subclass breeds a set of children from the Population,
 * then joins the original Population with the children in a (mu+mu) fashion. An
 * NSGA2Breeder may have multiple threads for breeding.
 * 
 * <p>
