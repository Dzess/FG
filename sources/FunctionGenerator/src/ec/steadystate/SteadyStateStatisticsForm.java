...
/**
 * This interface defines the hooks for SteadyStateEvolutionState objects to
 * update themselves on. Note that the the only methods in common with the
 * standard statistics are initialization and final. This is an optional
 * interface: SteadyStateEvolutionState will complain, but will permit
 * Statistics objects that don't adhere to it, though they will only have their
 * initialization and final statistics methods called!
 * 
 * <p>
 * See SteadyStateEvolutionState for how regular Statistics objects' hook
 * methods are called in steady state evolution.
 * 
 * @author Sean Luke
 * @version 1.0
 */
...
public interface SteadyStateStatisticsForm {
	...
	/**
	 * Called when we have filled the initial population and are entering the
	 * steady state.
	 */
