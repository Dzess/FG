...
public class SteadyStateEvolutionState extends EvolutionState {
	...
	public void setup(final EvolutionState state, final Parameter base) {
		...
		if (!(breeder instanceof SteadyStateBreeder))
			state.output.error("You've chosen to use Steady-State Evolution, but your breeder is not of the class SteadyStateBreeder.",
					base);
		if (!(evaluator instanceof SteadyStateEvaluator))
			state.output.error("You've chosen to use Steady-State Evolution, but your evaluator is not of the class SteadyStateEvaluator.",
					base);
	...
	public int evolve() {
		...
		if (ind != null) // do we have an evaluated individual?
		{
			...
			if (partiallyFullSubpop) // is subpopulation full?
			{
				...
				if (statistics instanceof SteadyStateStatisticsForm)
					((SteadyStateStatisticsForm) statistics).individualsEvaluatedStatistics(this, new Individual[] { ind },
							new Individual[] { deadInd }, new int[] { subpop }, new int[] { deadIndividual });
			}
