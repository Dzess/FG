 ...
 * Most applications don't need Exchanger facilities; this simple version will
 * suffice.
 * 
 * <p>
 * The SimpleExchanger implements the SteadyStateExchangerForm, mostly because
 * it does nothing with individuals. For this reason, it is final; implement
 * your own Exchanger if you need to do something more advanced.
 * 
 * @author Sean Luke
 * @version 1.0
 */
