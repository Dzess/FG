 ...
 * GPProblems hold one ADFStack, which is used to evaluate a large number of
 * trees without having to be garbage-collected and reallocated. Be sure to call
 * stack.reset() after each tree evaluation.
 * 
 * <p>
 * <b>Parameters</b><br>
 * <table>
 * <tr>
 * <td valign=top><i>base</i><tt>.stack</tt><br>
 * <font size=-1>classname, inherits or = ec.ADFStack</font></td>
 * <td valign=top>(the class for the GPProblem's ADF Stack)</td>
 * </tr>
 * <tr>
 * <td valign=top><i>base</i><tt>.data</tt><br>
 * <font size=-1>classname, inherits and != ec.GPData</font></td>
 * <td valign=top>(the class for the GPProblem's basic GPData type)</td>
 * </tr>
 * </table>
 * 
 * <p>
