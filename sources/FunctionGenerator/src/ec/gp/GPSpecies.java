...
/**
 * GPSpecies is a simple individual which is suitable as a species for GP
 * subpopulations. GPSpecies' individuals must be GPIndividuals, and often their
 * pipelines are GPBreedingPipelines (at any rate, the pipelines will have to
 * return members of GPSpecies!).
 * 
 * <p>
 * <b>Default Base</b><br>
 * gp.species
	...
	public void setup(final EvolutionState state, final Parameter base) {
		...
		if (!(i_prototype instanceof GPIndividual))
			state.output.fatal("The Individual class for the Species " + getClass().getName()
					+ " is must be a subclass of ec.gp.GPIndividual.", base);
	}
